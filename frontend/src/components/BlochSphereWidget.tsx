...
export const BlochSphereWidget: React.FC<BlochSphereWidgetProps> = ({ statevector, numQubits }) => {
  if (numQubits > 1) {
    return (
      <div className="p-4 rounded-2xl bg-warm-ivory/60 border border-soft-sand text-center space-y-2 shadow-sm">
    ...
    <div className="p-4 rounded-2xl bg-[#FFFDF7] border border-soft-sand space-y-3 shadow-sm">
      ...
      <div className="flex justify-center py-2">
        <svg viewBox="0 0 260 260" className="w-44 h-44 sm:w-48 sm:h-48 font-sans select-none" fill="none">
          ...
          {/* Equator ellipse */}
          <ellipse cx={cx} cy={cy} rx={r * cosA} ry={r * sinA} stroke="#31372B" strokeWidth="1.2" strokeDasharray="3 3" strokeOpacity="0.25" />
          ...
          {/* Vector tip */}
          <circle cx={x2d} cy={y2d} r={4.5} fill="#202C3D" />
        </svg>
      </div>
